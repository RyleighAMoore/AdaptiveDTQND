...
parameters = Parameters(sde, beta, radius, kstepMin, kstepMax, h, useAdaptiveMesh =useAdaptiveMesh, timeDiscretizationType = timeDiscretizationType, integratorType = integratorType)
